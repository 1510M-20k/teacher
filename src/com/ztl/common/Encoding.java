...
public class Encoding {
	 ...
	 * @return 明文,出错为null.
	 */
	public static String encodingToken(String code,String username,String keyword) {
		String str = username+code+"key="+Encoding.encoding(keyword);
		String key = RandomUtil.getCharAndNumr(8);
		String strs = Encoding.encoding(key,str);
		return strs+key;
	}
	/**
	 * 测试
...
//4QrcOUm6Wau+VuBX8g+IPg==
		...
		System.out.println(Encoding.encodingToken("YXK","15901455800","123456"));
	}
}