...
public class RandomUtil {
	...
	public static String getCharAndNumr2(int length) {
		...
		String str = "";
		String s = null;
		while (i < length) { // 这个地方的30控制产生几位随机数，这里是产生30位随机数
			switch (r.nextInt(63)) {
			case (0):
				s = "0";
				break;
	...
	public static String getCharAndNumr(int length) {
		...
		for (int i = 0; i < length; i++) {
			...
			if ("char".equalsIgnoreCase(charOrNum)) {
				...
				val += (char) (choice + random.nextInt(26));//字母总共26个，小写从65开始,大写人97开始
			} else if ("num".equalsIgnoreCase(charOrNum)) {// 数字，只有0-9
